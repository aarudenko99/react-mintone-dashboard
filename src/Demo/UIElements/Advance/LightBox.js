                            ...
                            <Card.Body>
                                <Row>
                                    <Col xl={2} lg={3} sm={4} xs={12}>
                                        <Gallery images={[{src: image1, thumbnail: thumb1, caption:"Mintone Image 1", useForDemo:true}]} backdropClosesModal singleItem />
                                    </Col>
                                    <Col xl={2} lg={3} sm={4} xs={12}>
                                        <Gallery images={[{src: image2, thumbnail: thumb2, caption:"Mintone Image 2", useForDemo:true}]} backdropClosesModal singleItem />
                                    </Col>
                                    <Col xl={2} lg={3} sm={4} xs={12}>
                                        <Gallery images={[{src: image3, thumbnail: thumb3, caption:"Mintone Image 3", useForDemo:true}]} backdropClosesModal singleItem />
                                    </Col>
                                    <Col xl={2} lg={3} sm={4} xs={12}>
                                        <Gallery images={[{src: image4, thumbnail: thumb4, caption:"Mintone Image 4", useForDemo:true}]} backdropClosesModal singleItem />
                                    </Col>
                                    <Col xl={2} lg={3} sm={4} xs={12}>
                                        <Gallery images={[{src: image5, thumbnail: thumb5, caption:"Mintone Image 5", useForDemo:true}]} backdropClosesModal singleItem />
                                    </Col>
                                    <Col xl={2} lg={3} sm={4} xs={12}>
                                        <Gallery images={[{src: image6, thumbnail: thumb6, caption:"Mintone Image 6", useForDemo:true}]} backdropClosesModal singleItem />
                                    </Col>
                                </Row>
                            </Card.Body>
                        </Card>
