                            ...
                            <div className="row no-gutters row-bordered">
                                    ...
                                    <div className="px-4 px-sm-5 pt-4 pb-5 pb-sm-5">
                                        ...
                                        <div className="form-group text-left mt-2">
                                            <div className="d-inline">
                                                <input type="checkbox" name="checkbox-fill-1" id="checkbox-fill-a1" defaultChecked={false}/>
                                                <label htmlFor="checkbox-fill-a1" className="cr"> Save credentials</label>
                                            </div>
                                        </div>
                                        <button className="btn btn-block btn-primary mb-4 rounded-pill">Signin</button>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-6 border-left border-light">
                                    ...
                                    <div className="px-4 px-sm-5 pt-4 pb-5 pb-sm-5">
                                        ...
                                        <div className="form-group text-left mt-2">
                                            <div className="d-inline">
                                                <input type="checkbox" name="checkbox-fill-2" id="checkbox-fill-2" defaultChecked={false}/>
