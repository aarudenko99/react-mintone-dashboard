            ...
            <Aux>
                ...
                <Row>
                    ...
                    <Col xl={8}>
                        <Card>
                            <Card.Header>
                                <Card.Title as='h5'><i className="fa fa-ticket-alt m-r-5"/> Ticket List Doesn't Support Commas</Card.Title>
                                <button className="btn btn-primary float-right"><i className="fa fa-bell m-r-5"/>Check in</button>
                            </Card.Header>
                            <Card.Body>
                                ...
                                <div className="float-right d-flex m-t-10">
                                    <span>
                                        <a href={DEMO.BLANK_LINK} className="text-muted m-r-10 f-16"><i className="fa fa-pencil-alt"/> </a>
                                    </span>
                                    <span className="m-r-10">
