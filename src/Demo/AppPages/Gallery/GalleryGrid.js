                            ...
                            <Card.Body>
                                <Row>
                                    <Col xl={4} md={6} className='mb-4'>
                                        <Gallery images={[{src: thumb1, thumbnail: thumb1, caption:"Mintone Image 1", useForDemo:true}]} backdropClosesModal singleItem />
                                    </Col>
                                    <Col xl={4} md={6} className='mb-4'>
                                        <Gallery images={[{src: thumb2, thumbnail: thumb2, caption:"Mintone Image 2", useForDemo:true}]} backdropClosesModal singleItem />
                                    </Col>
                                    <Col xl={4} md={6} className='mb-4'>
                                        <Gallery images={[{src: thumb3, thumbnail: thumb3, caption:"Mintone Image 3", useForDemo:true}]} backdropClosesModal singleItem />
                                    </Col>
                                    <Col xl={4} md={6} className='mb-4'>
                                        <Gallery images={[{src: thumb4, thumbnail: thumb4, caption:"Mintone Image 4", useForDemo:true}]} backdropClosesModal singleItem />
                                    </Col>
                                    <Col xl={4} md={6} className='mb-4'>
                                        <Gallery images={[{src: thumb5, thumbnail: thumb5, caption:"Mintone Image 5", useForDemo:true}]} backdropClosesModal singleItem />
                                    </Col>
                                    <Col xl={4} md={6} className='mb-4'>
                                        <Gallery images={[{src: thumb6, thumbnail: thumb6, caption:"Mintone Image 6", useForDemo:true}]} backdropClosesModal singleItem />
                                    </Col>
                                </Row>
                            </Card.Body>
                        </Card>
