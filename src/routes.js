...
const routes = [
    ...
    { path: '/dashboard/shop', exact: true, name: 'Crypto', component: DashboardShop },
    { path: '/dashboard/project/statistics', exact: true, name: 'Crypto', component: StatisticsProject },
    { path: '/dashboard/project/details', exact: true, name: 'Crypto', component: DetailsProject },
    { path: '/dashboard/project/task-manager', exact: true, name: 'Crypto', component: TaskManagerProject },
    { path: '/dashboard/project/members', exact: true, name: 'Crypto', component: MembersProject },
